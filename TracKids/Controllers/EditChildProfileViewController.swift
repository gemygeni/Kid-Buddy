...
class EditChildProfileViewController: UIViewController {
    ...
    alert.addAction(UIAlertAction(title: "Take By Camera", style: .default, handler: {[weak self]_ in
        ...
        alert.addAction(UIAlertAction(title: "Select From Library", style: .default, handler: { [weak self]_ in
    ...
    guard let childId = childId, let newImage = profileImage, nameTextField.text != nil, let newName = nameTextField.text else {return}
